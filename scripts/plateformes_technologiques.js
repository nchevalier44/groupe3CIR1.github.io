...
function ModalWindow(number){
    ...
    if(number == 1){
        ...
        //CSS de la fenetre modale 1
        modalContainer1.style.position = "fixed";
        modalContainer1.style.top = "10%";
        modalContainer1.style.left = "15%";
        modalContainer1.style.width = "70%";
        modalContainer1.style.height = "80%";
        modalContainer1.style.backgroundColor = "#D1E8E2";
        ...
        modalContainer1.style.padding = "30px";
        ...
        let imgModal2 = document.getElementById("img_environnementHybride").cloneNode(true); //cloneNode permet de cloner l'élément voulu, ainsi on ne modifie pas l'élément de base mais une "copie"
        ...
        let imgClose = document.createElement("img");
        imgClose.src = "images/icones/close.svg";
        closeButton2.appendChild(imgClose);
        ...
        //CSS de la fenetre modale 2
        modalContainer2.style.position = "fixed";
        modalContainer2.style.top = "10%";
        modalContainer2.style.left = "15%";
        modalContainer2.style.width = "70%";
        modalContainer2.style.height = "80%";
        modalContainer2.style.backgroundColor = "#D1E8E2";
        ...
        modalContainer2.style.padding = "30px";
...
title1.addEventListener("click", () =>{
    ModalWindow(1);    //on passe le display en block pour afficher à l'écran le div modalContainer
    let f = document.getElementsByClassName("flou"); 
    for(let i = 0; i<f.length; i++){
